App.controller('StandardImportController', ['$scope', 'Upload', '$timeout', 'modalInstance', function ($scope, Upload, $timeout, modalInstance) {
    ...
    $scope.ok = function () {
        ...
        auxo.array.forEach($scope.data, function (e, j) {
            if(j>0) {
                list.push( {code: e[0], name: e[1], index:j});
            }
        })
